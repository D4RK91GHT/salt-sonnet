                                            ...
                                            <div class="row">
                                                        ...
                                                        @foreach ($order->items as $item)
                                                            <li
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <span class="badge bg-light text-dark fw-normal">{{ $item->variations->first()->name }}</span>
                                                                    <br>
                                                ...
                                                <div class="col-md-6">
                                                    <h6>Delivery Information <span
                                                            class="badge bg-{{ $order->status === 'completed' ? 'success' : ($order->status === 'cancelled' ? 'danger' : 'warning') }}">{{ ucfirst($order->status) }}</span></h6>
