...
@php
    $inputClass = 'block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 dark:text-gray-300 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:border-gray-600 focus:outline-none focus:ring-0 focus:border-blue-600 peer' . ($errors->has($name) ? ' border-red-500' : '');
@endphp
